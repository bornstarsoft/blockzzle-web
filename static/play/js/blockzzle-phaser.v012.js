(function (root, factory) {
  ...
  class BlockzzleScene extends SceneBase {
    ...
    toggleSound() {
      this.setSoundEnabled(!this.soundEnabledPreference, "sound-toggle").catch(() => {});
    }
    ...
    getAudioContext() {
      if (!this.soundEnabledPreference || typeof window === "undefined") return null;
    ...
    setSoundEnabled(enabled, reason) {
      ...
      this.addAudioUnlockListeners();
      this.updateSoundButton();
      return this.unlockAudioFromGesture(reason || "sound-toggle", { force: true })
        .then((ready) => {
          if (ready) {
            this.saveSoundPreference();
            this.updateSoundButton();
