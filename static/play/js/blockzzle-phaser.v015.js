(function (root, factory) {
  ...
  class BlockzzleScene extends SceneBase {
    ...
    renderGameOverPanel() {
      ...
      panel.setDepth(90);
      const title = this.add.text(centerX, centerY - 134, "Game over", this.smallTextStyle(27, "#f8fbff", "800"));
      ...
      stats.setDepth(91);
      const button = this.add.text(centerX, centerY + 106, "Play Again", this.smallTextStyle(16, "#07111f", "800"))
        .setOrigin(0.5, 0)
        .setPadding(28, 11)
        .setBackgroundColor("#8ee8d2")
        .setInteractive({ useHandCursor: true })
