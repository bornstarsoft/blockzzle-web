(function (root, factory) {
  ...
  class BlockzzleScene extends SceneBase {
    ...
    resizeLayout() {
      ...
      this.nextGoalText.setPosition(this.boardOrigin.x, Math.max(topY + 68, this.boardOrigin.y - (tiny ? 16 : 22)));
    ...
    renderGameOverPanel() {
      ...
      panel.setDepth(90);
      const title = this.add.text(centerX, centerY - 140, "Game over", this.smallTextStyle(27, "#f8fbff", "800"));
      ...
      const stats = this.add.text(
        ...
        [
          ...
          `Score Tier: ${scoreTier.label}    Best Tier: ${bestScoreTier.label}`,
      ...
      stats.setDepth(91);
      const button = this.add.text(centerX, centerY + 118, "Play Again", this.smallTextStyle(16, "#07111f", "800"))
        .setOrigin(0.5, 0)
        .setPadding(28, 11)
        .setBackgroundColor("#8ee8d2")
        .setInteractive({ useHandCursor: true })
