  ...
  class BlockzzleScene extends SceneBase {
    ...
    resizeLayout() {
      ...
      this.leaderboardButton.setPosition(
        width - this.leaderboardButton.width - margin,
        this.nextGoalText.y - (tiny ? 3 : 4)
      );
    ...
    renderGameOverPanel() {
      ...
      const nicknameLine = this.leaderboardSubmitted
        ? "Score submitted"
      ...
      const submitButton = this.add.text(panelLayout.submitButton.x, panelLayout.submitButton.y, submitLabel, this.smallTextStyle(13, "#07111f", "800"))
        .setOrigin(0.5, 0)
        .setPadding(22, 8)
      ...
      const submitStatus = this.add.text(
        ...
        this.leaderboardSubmitStatus || "Local stats stay saved if the board is unavailable.",
