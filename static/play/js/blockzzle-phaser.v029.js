(function (root, factory) {
  ...
  function getPlayLayoutProfile(options) {
    ...
    if (!embedHome) {
      return {
        ...
        metricChipGap: compact ? 5 : 8,
        metricChipHeight: tiny ? 30 : compact ? 34 : 38,
        metricChipWidths: compact ? [92, 82, 104, 72] : [124, 116, 124, 98],
      };
    }
    return {
      compact,
      ...
      metricChipGap: 4,
      metricChipHeight: tiny ? 28 : 32,
      metricChipWidths: tiny ? [76, 66, 84, 58] : [78, 70, 88, 60],
    };
  }
  ...
  class BlockzzleScene extends SceneBase {
    ...
    resizeLayout() {
      ...
      const chipGap = profile.metricChipGap;
      const chipHeight = profile.metricChipHeight;
      const chipWidths = profile.metricChipWidths;
      let chipX = margin;
